...
internal class MultiTouchListener(
    ...
    private inner class ScaleGestureListener(private val view: View) :
        ...
        override fun onScaleBegin(detector: ScaleGestureDetector): Boolean {
            ...
            mPrevSpan = detector.currentSpan
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            info.deltaAngle = if (isRotateEnabled) {
                val currentSpanX = detector.currentSpanX
                val currentSpanY = detector.currentSpanY
                Vector2D.getAngle(Vector2D(currentSpanX, currentSpanY), mPrevSpanVector)
            } else 0.0f
    ...
    init {
        val scaleGestureListener = ScaleGestureListener(photoEditorView)
